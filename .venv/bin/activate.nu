...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/ore/react_django/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('react-django-py3.10' == '') {
...
alias deactivate = source '/home/ore/react_django/.venv/bin/deactivate.nu'
